...
-- Copied directly from GHC.
-- Note that this module contains Note [The one-shot state monad trick],
-- which GHC refers to a lot, but which I do not plan to refer to at all
-- for a while as it is really a performance thing.
